...
namespace Starshine.Authservice.Application.Contracts.Dtos.ClientManager
{
    /// <summary>
    /// 客户端创建更新model
    /// </summary>
    public class ClientCreateParamDto
    {
    ...
    /// 客户端作用域/允许跨域创建model
    /// </summary>
    public class ClientScCreateParamDto
    {
        /// <summary>
        /// 客户端id
        /// </summary>
    ...
    /// 客户端回调/退出回调创建model
    /// </summary>
    public class ClientRuCreateParamDto
    {
        /// <summary>
        /// 客户端id
        /// </summary>
