...
using Starshine.Authservice.Application.Contracts.Dtos.Oauth2;

namespace Starshine.Authservice.Controllers.Oauth2
{
    public class Oauth2Controller : BaseController
    {
        ...
        public async Task<IActionResult> Authorize(LoginParamDto model, string button)
        {
        ...
        private async Task<LoginViewModel> BuildLoginViewModelAsync(LoginParamDto model)
        {
        ...
        private async Task<LoggedOutViewDto> BuildLoggedOutViewModelAsync(string logoutId)
        {
            // get context information (client name, post logout redirect URI and iframe for federated signout)
            var logout = await _interaction.GetLogoutContextAsync(logoutId);
            var vm = new LoggedOutViewDto
            {
