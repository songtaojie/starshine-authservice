...
{
    public class ApiScopeRepository : EfCoreRepository<IAuthserviceDbContext, ApiScope, Guid>, IApiScopeRepository
    {
        public ApiScopeRepository(IDbContextProvider<IAuthserviceDbContext> dbContextProvider) : base(
            dbContextProvider)
        {
        }
