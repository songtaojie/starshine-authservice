...
namespace Starshine.Authservice.EntityFrameworkCore.SeedDatas
{
    ...
    public class SeedData
    {
        public static void EnsureSeedData(IServiceProvider serviceProvider)
        {
            ...
            //dotnet ef -s src/Starshine.Authservice -p src/Starshine.Authservice.Model migrations add InitApplicationDb -c ApplicationDbContext
            //  dotnet ef -s src/Starshine.Authservice -p src/Starshine.Authservice.Model migrations remove -c ApplicationDbContext
            // dotnet ef -s src/Starshine.Authservice -p src/Starshine.Authservice.Model migrations add InitPersistedGrantDb -c PersistedGrantDbContext -o Migrations/IdentityServer/PersistedGrantDb
            // dotnet ef -s src/Starshine.Authservice -p src/Starshine.Authservice.Model migrations remove -c PersistedGrantDbContext
        ...
        public static void EnsureSeedData(IServiceProvider serviceProvider, ApplicationDbContext context)
        {
            ...
            userList.ForEach(user =>
            {
                ...
                if (userItem == null)
                {
                    ...
                    ConsoleHelper.WriteErrorLine($"{userItem.UserName} created",false, ConsoleColor.Green);
                }
                else
                {
