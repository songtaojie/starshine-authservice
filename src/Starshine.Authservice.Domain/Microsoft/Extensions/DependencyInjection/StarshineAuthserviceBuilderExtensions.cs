...
using Starshine.Authservice.Domain.AspNetIdentity;
using System;
...
{
    public static class StarshineAuthserviceBuilderExtensions
    {
        public static IIdentityServerBuilder AddAbpIdentityServer(this IIdentityServerBuilder builder, AbpIdentityServerBuilderOptions options = null)
        {
            if (options == null)
            {
            ...
            builder.Services.Replace(ServiceDescriptor.Transient<IClaimsService, StarshineAuthserviceClaimsService>());
